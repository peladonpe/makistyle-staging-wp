...
$mostrar_busqueda = is_page('tienda') && !isset($_GET['precio']);
$terminos = get_terms([
		...
		<div class="mkv2-modal-dialog">
			<form id="formulario-filtro">
				...
				<div class="mkv2-modal-body">
					...
					<div class="mkv2-form-check">
						<input type="checkbox" id="check-es-gratuito" value="" />
						<label for="check-es-gratuito"><?php esc_html_e('Solo gratuitos', 'makistyle'); ?></label>
					</div>
				</div>
