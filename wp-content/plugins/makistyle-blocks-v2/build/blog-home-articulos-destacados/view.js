/******/ (() => { // webpackBootstrap
/*!****************************************************!*\
  !*** ./src/blog-home-articulos-destacados/view.js ***!
  \****************************************************/
(function () {
  const sections = document.querySelectorAll('.wp-block-makistyle-blocks-v2-blog-home-articulos-destacados');
  sections.forEach(function (section) {
    const track = section.querySelector('.blog__cards-container');
