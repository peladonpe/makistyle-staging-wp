...
if (!function_exists('mkv2_blog_get_articulo')):
	function mkv2_blog_get_articulo()
	{
		...
		// ── Columna media ─────────────────────────────────────────────────────
		if ($idYoutube) {
			// Imagen como reserva de altura (invisible) + spinner + iframe sobrepuesto
			...
			$htmlYoutubeFinal = sprintf(
				/*html*/ '
				<div id="%1$s" class="mk-spinner-div">
...
// ── Lógica principal ──────────────────────────────────────────────────────────
// Usa el loop nativo de WordPress (main query), ya filtrado por la página de blog.
...
<section <?php echo get_block_wrapper_attributes([
	...
	<?php else: ?>
		<p class="blog-listado__sin-resultados">
