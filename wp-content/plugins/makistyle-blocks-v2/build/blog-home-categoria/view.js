/******/ (() => { // webpackBootstrap
/*!*****************************************!*\
  !*** ./src/blog-home-categoria/view.js ***!
  \*****************************************/
(function () {
  const sections = document.querySelectorAll('.wp-block-makistyle-blocks-v2-blog-home-categoria');
  sections.forEach(function (section) {
    const track = section.querySelector('.blog-categoria__cards-container');
