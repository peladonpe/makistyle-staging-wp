...
function meta_fields_register_meta()
{
	...
	function registrar_campos_personalizados_posts(
		$metafield,
		$type = 'string',
		$sanitize_callback = 'sanitize_text_field',
		$post_type = '',
	) {
		register_post_meta($post_type, $metafield, [
			'single' => true,
			'type' => $type,
			'show_in_rest' => true,
	...
	registrar_campos_personalizados_posts(
	...
	registrar_campos_personalizados_posts(
		...
		'number',
		'sanitize_precio_meta',
		'tienda_pt',
	);
	registrar_campos_personalizados_posts(
		'makistyle_cmb2_tienda_enlace_compra',
		'string',
		'esc_url_raw',
		'tienda_pt',
	);
	...
	registrar_campos_personalizados_posts(
		'makistyle_cmb2_descripcion_post',
		'string',
		'wp_kses_post',
		'tienda_pt',
	);
