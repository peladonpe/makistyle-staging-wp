...
/**
 * Registra los campos personalizados (metaboxes) de CMB2 para la taxonomía de promociones
 * ("promociones_taxonomia"). Habilita la configuración detallada de promociones, incluyendo
 * porcentaje de rebaja, código del cupón, rango de fechas válidas y estado de activación.
 */
...
/**
 * Registra los campos personalizados (metaboxes) de CMB2 para la taxonomía "tipo_recurso_taxonomia",
 * permitiendo definir propiedades adicionales como el nombre en singular para cada tipo de recurso.
 */
